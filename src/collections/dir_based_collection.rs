    ...
    T: Document<T> + Serialize + DeserializeOwned + Clone + Sync + Send + 'static + Debug,
{
    ...
    pub fn new(dir: PathBuf) -> Self {
        let mut collection = DirBasedCollection {
    ...
    pub fn new_arc(fp: PathBuf) -> Arc<RwLock<DirBasedCollection<T>>> {
        let c = DirBasedCollection::new(fp);
...
mod test {
    ...
    fn test_insert() {
        ...
        let mut c = DirBasedCollection::<User>::new(fp);
